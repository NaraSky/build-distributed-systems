...
Should sample 2 random backends and select the one with fewer connections. Response should include sampled backends.
...
### 2. Comparison with least-connections
...
- [The Power of Two Random Choices](http://www.eecs.harvard.edu/~michaelm/postscripts/im2002b.pdf): Original paper on the power-of-two-choices technique
